...
{/*Intro*/}
<section id="intro" class="wrapper lg:grid grid-cols-12 text-left">
...
<section class="wrapper-wide grid grid-cols-12 text-left">
...
{/*Mockup*/}
<section id="mockup" class="bg-darkgray md:mt-60 !mb-0 pb-16 md:pb-32">
...
<div class="bg-darkgray text-white">
  ...
  {/*Stats*/}
  <section id="stats" class="wrapper text-center pt-12 md:pt-36">
  ...
  {/* Mockups */}
  <section id="mockups" class="lg:px-[--container-margin] mt-20 lg:mt-0">
  ...
  {/*Quote*/}
  <section id="quote" class="wrapper pt-32 pb-12 mb-20 md:py-36 text-left">
    <div class="max-w-lg">
